	...
	switch (newStep) {
		case 1: // A-B
			...
			modifyReg16(&FLEXPWM0->DTSRCSEL,
				    PWM_DTSRCSEL_SM0SEL23_MASK | PWM_DTSRCSEL_SM1SEL23_MASK | PWM_DTSRCSEL_SM2SEL23_MASK,
...
void proportionalBrake()
{
	//Set source using DTSRCSEL
#ifdef INVERT_PWM
	modifyReg16(&FLEXPWM0->DTSRCSEL, 0xfff, PWM_DTSRCSEL_SM0SEL23(0) | PWM_DTSRCSEL_SM1SEL23(0) | PWM_DTSRCSEL_SM2SEL23(0));
#else
	modifyReg16(&FLEXPWM0->DTSRCSEL, 0xfff, PWM_DTSRCSEL_SM0SEL23(1) | PWM_DTSRCSEL_SM1SEL23(1) | PWM_DTSRCSEL_SM2SEL23(1));
#endif
