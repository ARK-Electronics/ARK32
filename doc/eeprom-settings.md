...
| Motor KV | `MOTOR_KV` | 20–10220 (40 kV steps) | 1020 | Nameplate kV. Used for the low-rpm throttle envelope and for auto timing. Wrong kV can cap top end or make timing too aggressive. Every value except 20 limits duty at low rpm (20% at standstill, never below Minimum duty cycle plus Startup power), releasing it as the motor spins up; **20 turns that low-rpm limit off**. For a motor under 60 kV, enter 60 to keep it. See [`low-kv-protection.md`](low-kv-protection.md). |
