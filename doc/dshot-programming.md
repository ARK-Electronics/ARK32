...
Addresses run 0..191, the size of the EEPROM buffer. An out-of-range address still consumes its value frame and command 37, and the transaction ends without writing. Values use the low 8 bits of the value frame. For the motor pole count, a resulting byte outside 2..128 is replaced with the default of 14 before the write.
